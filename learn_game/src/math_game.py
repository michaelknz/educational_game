...
class math_game:
    ...
    def new_level(self,is_right):
        ...
        self.screen.blit(t,(self.screen.get_width()//2-t.get_width()//2,self.screen.get_height()//2-t.get_height()//2-100))
    ...
    def update(self,is_clicked,pos):
        ...
        self.screen.blit(self.surf,(self.screen.get_width()//2-self.surf.get_width()//2,self.screen.get_height()//2-self.surf.get_height()//2-100))
